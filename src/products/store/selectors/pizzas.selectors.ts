...
export const getSelectedPizza = createSelector(getPizzasEntities, fromRoot.getRouterState, (entities, {state: routerState}): Pizza => {
	return routerState && entities[routerState.params.pizzaId];
});
